 ...
 * @author philip Agbor
 */
public class Verg2Controller implements Initializable {
    ...
    @FXML
    private void NEXT_verg3(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_verg1(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
          String musicFile = "C:\\Users\\philip Agbor\\Documents\\Sound recordings\\Recording (54).M4A";
