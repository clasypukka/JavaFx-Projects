...
public class WController implements Initializable {
    ...
    @FXML
    private void NEXT_X(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_V(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
        String musicFile = "C:\\Users\\CLASYPUKKA\\Desktop\\projects\\KIDS_APP\\src\\AUDIO\\WATCH.mp3";
