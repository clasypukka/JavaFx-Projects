 ...
 * @author philip Agbor
 */
public class Anim8Controller implements Initializable {
    ...
    @FXML
    private void next_anim9(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_anim7(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
          String musicFile = "C:\\Users\\philip Agbor\\Documents\\Sound recordings\\Recording (69).M4A";
