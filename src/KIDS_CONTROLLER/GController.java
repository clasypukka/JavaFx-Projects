...
public class GController implements Initializable {
    ...
    @FXML
    private void next_h(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_f(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
        String musicFile = "C:\\Users\\CLASYPUKKA\\Desktop\\projects\\KIDS_APP\\src\\AUDIO\\GOAT.mp3";
