...
public class DController implements Initializable {
    ...
    @FXML
    private void next_e(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_c(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
        String musicFile = "C:\\Users\\CLASYPUKKA\\Desktop\\projects\\KIDS_APP\\src\\AUDIO\\DOG.mp3";
