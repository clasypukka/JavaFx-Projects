...
public class KController implements Initializable {
    ...
    @FXML
    private void next_l(ActionEvent event) throws IOException {
    ...
    @FXML
    private void BACK_j(ActionEvent event) throws IOException {
    ...
    private void speak(ActionEvent event) {
        String musicFile = "C:\\Users\\CLASYPUKKA\\Desktop\\projects\\KIDS_APP\\src\\AUDIO\\KETTLE.mp3";
